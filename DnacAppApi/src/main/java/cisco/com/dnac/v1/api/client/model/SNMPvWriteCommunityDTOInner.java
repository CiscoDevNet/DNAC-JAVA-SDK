...
public class SNMPvWriteCommunityDTOInner {
  ...
  @SerializedName("writeCommunity")
  private String writeCommunity = null;

  public SNMPvWriteCommunityDTOInner comments(String comments) {
  ...
  **/
  ...
  public SNMPvWriteCommunityDTOInner credentialType(CredentialTypeEnum credentialType) {
  ...
  **/
  ...
  public SNMPvWriteCommunityDTOInner description(String description) {
  ...
  **/
  ...
  public SNMPvWriteCommunityDTOInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public SNMPvWriteCommunityDTOInner instanceTenantId(String instanceTenantId) {
  ...
  **/
  ...
  public SNMPvWriteCommunityDTOInner instanceUuid(String instanceUuid) {
  ...
  **/
  ...
  public SNMPvWriteCommunityDTOInner writeCommunity(String writeCommunity) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SNMPvWriteCommunityDTOInner snMPvWriteCommunityDTOInner = (SNMPvWriteCommunityDTOInner) o;
    return Objects.equals(this.comments, snMPvWriteCommunityDTOInner.comments) &&
        Objects.equals(this.credentialType, snMPvWriteCommunityDTOInner.credentialType) &&
        Objects.equals(this.description, snMPvWriteCommunityDTOInner.description) &&
        Objects.equals(this.id, snMPvWriteCommunityDTOInner.id) &&
        Objects.equals(this.instanceTenantId, snMPvWriteCommunityDTOInner.instanceTenantId) &&
        Objects.equals(this.instanceUuid, snMPvWriteCommunityDTOInner.instanceUuid) &&
        Objects.equals(this.writeCommunity, snMPvWriteCommunityDTOInner.writeCommunity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comments, credentialType, description, id, instanceTenantId, instanceUuid, writeCommunity);
  }
